...
# Define landmark dictionary with the corrected center for the right eye
land_dict = {
    "right": {
        "left": 133,
        "right": 33,
        "upper": 27,
        "lower": 23,
        "center": 468  # Corrected to 468 for the center (pupil) of the right eye
    },
    "left": {
        "left": 263,
        "right": 362,
        ...
        if results.multi_face_landmarks:
            for face_landmarks in results.multi_face_landmarks:
                ...
                pix_dict = {
                    ...
                    "image": image  # Add the actual frame to pix_dict
                }
